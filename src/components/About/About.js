...
const About = () => {
    return (
            <div className='grid  grid-cols-1 lg:grid-cols-2 w-[85%] mx-auto gap-10 lg:mt-28 e_sm:mt-[65rem] mt-[77rem]'>
            <div className="">
                <img src={aboutImage} alt="aboutImage" className='lg:w-auto w-4/5 mx-auto' />
            </div>
            <div className="flex flex-col justify-center w-full lg:w-2/3 mx-auto col-end-auto">
